...
try:
    with conexion:
        with conexion.cursor() as cursor:
            sentencia = 'DELETE FROM persona WHERE id_persona IN %s' #IN para varios
            entrada = input('Ingresa...: ')
            valores = (tuple(entrada.split(',')),)
            print(valores)

            #valores = (('7',),('9',),('10',))#Tupla

            cursor.execute(sentencia, valores) #Excecutemany para varios valores.
