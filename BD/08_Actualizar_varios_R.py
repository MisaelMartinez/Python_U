    ...
    with conexion:
        with conexion.cursor() as cursor:
            ...
            valores = (('Misael','Campistrano','Gas@gmai.com','10'),
                       ('Misael','Campistrano','Gas@gmai.com','9'),
                       ('Misael','Campistrano','Gas@gmai.com','8'))#Tupla de tuplas.

            cursor.executemany(sentencia, valores) #Excecutemany para varios valores.
